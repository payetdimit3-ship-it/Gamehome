...
(function(){
  ...
  var NAV = [
    ...
    ['AI Assistant','index.html#ai','bot'], ['Marketplace','marketplace.html','shop'], ['Wishlist','wishlist.html','heart'],
  ...
  function item(n,h,i,badge){
    return '<a class="zp-nav-item'+(isActive(h,false)?' active':'')+'" href="'+h+'">'+ZP.icon(i)+'<span>'+n+'</span>'+(badge?'<em id="zpCartNav" data-n="0">0</em>':'')+'</a>';
  }
  ...
  function build(){
    ...
    ai && ai.addEventListener('click', function(){ var b=document.getElementById('ghChatBtn'); if(b) b.click(); });
